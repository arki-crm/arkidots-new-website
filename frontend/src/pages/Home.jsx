      ...
      <section className="py-20 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-stone-900 mb-4">Interior Design Services by Arki Dots</h2>
            <p className="text-lg text-stone-600 max-w-2xl mx-auto">Comprehensive interior solutions for homes in Vatakara, Kozhikode, Kannur, and across Kerala</p>
          </div>
